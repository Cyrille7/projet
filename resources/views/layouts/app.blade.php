...
<link href="{{asset('main.87c0748b313a1dda75f5.css')}}" rel="stylesheet"></head>
<body>
                            ...
                            <!--<li class="theme-settings-swatches d-none list-group-item">
                                ...
                                <div class="swatch-holder swatch-holder-img active">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{asset('assets/images/sidebar/city1.jpg')}}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{asset('assets/images/sidebar/city2.jpg')}}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{asset('assets/images/sidebar/city3.jpg')}}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{asset('assets/images/sidebar/city4.jpg')}}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{asset('assets/images/sidebar/city5.jpg')}}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{asset('assets/images/sidebar/abstract1.jpg')}}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{asset('assets/images/sidebar/abstract2.jpg')}}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{asset('assets/images/sidebar/abstract3.jpg')}}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{asset('assets/images/sidebar/abstract4.jpg')}}">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="{{asset('assets/images/sidebar/abstract5.jpg')}}">
                                    </a>
                                </div>
                            </li>-->
                        </ul>
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-left mr-3">
                                        <div class="widget-content-left"><img width="42" class="rounded" src="{{asset('assets/images/avatars/1.jpg')}}" alt=""/></div>
                                    </div>
                                    <div class="widget-content-left">
