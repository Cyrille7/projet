...
@section('content')
                ...
                <div class="app-main__inner">
                    <div class="app-page-title">
                        ...
                        <li class="nav-item">
                            <a role="tab" class="nav-link active" href="{{asset('index.html')}}">
                                <span>Variation 1</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a role="tab" class="nav-link" href="{{asset('analytics-variation.html')}}">
